          ...
          <div>
            ...
            <AnimatedElement animation="slide-up" delay={600} duration={800}>
              <div className="flex flex-wrap gap-4">
                <Link 
                  to="/contact" 
                  className="btn bg-white text-secondary-800 hover:bg-white/90 shadow-lg shadow-white/20"
                >
                  Get a Quote
                </Link>
                <Link 
                  to="/services" 
                  className="btn border-2 border-white text-white hover:bg-white/10 group"
                >
                  Explore Services
